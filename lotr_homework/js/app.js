...
const makeMiddleEarth = () => {
    ...
    const $section = $('<section id:MiddleEarth>');
    ...
    const $ul = $('<ul/>');
    // then make a loop to go through the array of baddies
   ...
   // }
    ...
    const $ulBuddies = $('<ul>').appendTo($('aside'));
    ...
    const $div = $('<div id=\'gollum\'><div/>').appendTo('#Mordor');
